...
export default function Home() {
  return (
    <main className="flex min-h-screen mx-auto flex-col items-center justify-center text-center bg-[url('https://raw.githubusercontent.com/sniffowomo/sn-utws28-1/w1/tc282/src/app/components/bd.gif')] bg-fixed bg-center">
